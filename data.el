...
(defun 9p-pbit16-le (string offset value)
...
(defun 9p-gbit16-le (string offset)
...
(defun 9p-pbit32-le (string offset value)
...
(defun 9p-gbit32-le (string offset)
...
(defun 9p-pbit64-le (string offset value)
...
(defun 9p-gbit64-le (string offset)
